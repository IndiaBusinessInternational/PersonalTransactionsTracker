// TSM Personal Transactions Tracker — GAS Backend v6.8.2  (same version number as the web app)
...
const APP_VERSION = "6.8.2";   // kept in step with the web app's badge (7 Sep 2026)
